...
Generate content for section `section-07-migration-tests` (filename: `section-07-migration-tests.md`).
...
for `section-07-migration-tests` to understand what this section should contain.
...
`/home/user/sitemgr/01-data-foundation/sections/section-07-migration-tests.md`
