...
Generate content for section `section-09-event-id` (filename: `section-09-event-id.md`).
...
for `section-09-event-id` to understand what this section should contain.
...
`/home/user/sitemgr/01-data-foundation/sections/section-09-event-id.md`
