...
Generate content for section `section-03-client-refactor` (filename: `section-03-client-refactor.md`).
...
for `section-03-client-refactor` to understand what this section should contain.
...
`/home/user/sitemgr/01-data-foundation/sections/section-03-client-refactor.md`
