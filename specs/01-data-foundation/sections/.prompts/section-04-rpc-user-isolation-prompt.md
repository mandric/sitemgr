...
Generate content for section `section-04-rpc-user-isolation` (filename: `section-04-rpc-user-isolation.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/user/sitemgr/01-data-foundation/claude-plan.md` - Full implementation plan
2. `/home/user/sitemgr/01-data-foundation/claude-plan-tdd.md` - Test stubs for each section
3. `/home/user/sitemgr/01-data-foundation/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-04-rpc-user-isolation` to understand what this section should contain.
...
`/home/user/sitemgr/01-data-foundation/sections/section-04-rpc-user-isolation.md`
