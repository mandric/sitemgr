...
Generate content for section `section-04-webhook-service-account` (filename: `section-04-webhook-service-account.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/user/sitemgr/specs/11-service-role-key-audit/claude-plan.md` - Full implementation plan
2. `/home/user/sitemgr/specs/11-service-role-key-audit/claude-plan-tdd.md` - Test stubs for each section
3. `/home/user/sitemgr/specs/11-service-role-key-audit/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-04-webhook-service-account` to understand what this section should contain.
...
`/home/user/sitemgr/specs/11-service-role-key-audit/sections/section-04-webhook-service-account.md`
