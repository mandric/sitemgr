...
Generate content for section `section-01-es256-workaround` (filename: `section-01-es256-workaround.md`).
...
for `section-01-es256-workaround` to understand what this section should contain.
...
`/home/user/sitemgr/specs/11-service-role-key-audit/sections/section-01-es256-workaround.md`
