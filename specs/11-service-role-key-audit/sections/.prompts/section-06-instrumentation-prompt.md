...
Generate content for section `section-06-instrumentation` (filename: `section-06-instrumentation.md`).
...
for `section-06-instrumentation` to understand what this section should contain.
...
`/home/user/sitemgr/specs/11-service-role-key-audit/sections/section-06-instrumentation.md`
