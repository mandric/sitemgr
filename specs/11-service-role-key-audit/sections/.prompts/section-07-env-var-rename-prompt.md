...
Generate content for section `section-07-env-var-rename` (filename: `section-07-env-var-rename.md`).
...
for `section-07-env-var-rename` to understand what this section should contain.
...
`/home/user/sitemgr/specs/11-service-role-key-audit/sections/section-07-env-var-rename.md`
