...
Generate content for section `section-05-cli-user-client` (filename: `section-05-cli-user-client.md`).
...
for `section-05-cli-user-client` to understand what this section should contain.
...
`/home/user/sitemgr/specs/11-service-role-key-audit/sections/section-05-cli-user-client.md`
