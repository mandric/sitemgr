...
Generate content for section `section-03-agent-core-refactor` (filename: `section-03-agent-core-refactor.md`).
...
for `section-03-agent-core-refactor` to understand what this section should contain.
...
`/home/user/sitemgr/specs/11-service-role-key-audit/sections/section-03-agent-core-refactor.md`
