...
Generate content for section `section-10-ci-workflow` (filename: `section-10-ci-workflow.md`).
...
for `section-10-ci-workflow` to understand what this section should contain.
...
`/home/user/sitemgr/specs/11-service-role-key-audit/sections/section-10-ci-workflow.md`
