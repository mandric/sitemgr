...
Generate content for section `section-08-test-app-layer` (filename: `section-08-test-app-layer.md`).
...
for `section-08-test-app-layer` to understand what this section should contain.
...
`/home/user/sitemgr/specs/11-service-role-key-audit/sections/section-08-test-app-layer.md`
