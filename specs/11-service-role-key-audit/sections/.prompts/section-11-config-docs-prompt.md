...
Generate content for section `section-11-config-docs` (filename: `section-11-config-docs.md`).
...
for `section-11-config-docs` to understand what this section should contain.
...
`/home/user/sitemgr/specs/11-service-role-key-audit/sections/section-11-config-docs.md`
