...
Generate content for section `section-02-health-endpoint` (filename: `section-02-health-endpoint.md`).
...
for `section-02-health-endpoint` to understand what this section should contain.
...
`/home/user/sitemgr/specs/11-service-role-key-audit/sections/section-02-health-endpoint.md`
