...
Generate content for section `section-05-validate-settings` (filename: `section-05-validate-settings.md`).
...
for `section-05-validate-settings` to understand what this section should contain.
...
`/home/user/sitemgr/specs/plugin-setup/sections/section-05-validate-settings.md`
