...
Generate content for section `section-07-hook-fallback` (filename: `section-07-hook-fallback.md`).
...
for `section-07-hook-fallback` to understand what this section should contain.
...
`/home/user/sitemgr/specs/plugin-setup/sections/section-07-hook-fallback.md`
