...
Generate content for section `section-03-add-marketplaces` (filename: `section-03-add-marketplaces.md`).
...
for `section-03-add-marketplaces` to understand what this section should contain.
...
`/home/user/sitemgr/specs/plugin-setup/sections/section-03-add-marketplaces.md`
