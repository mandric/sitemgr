...
Generate content for section `section-02-remove-manual-config` (filename: `section-02-remove-manual-config.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/user/sitemgr/specs/plugin-setup/claude-plan.md` - Full implementation plan
2. `/home/user/sitemgr/specs/plugin-setup/claude-plan-tdd.md` - Test stubs for each section
3. `/home/user/sitemgr/specs/plugin-setup/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-02-remove-manual-config` to understand what this section should contain.
...
`/home/user/sitemgr/specs/plugin-setup/sections/section-02-remove-manual-config.md`
