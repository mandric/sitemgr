...
Generate content for section `section-08-final-commit` (filename: `section-08-final-commit.md`).
...
for `section-08-final-commit` to understand what this section should contain.
...
`/home/user/sitemgr/specs/plugin-setup/sections/section-08-final-commit.md`
