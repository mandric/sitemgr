...
Generate content for section `section-04-install-plugins` (filename: `section-04-install-plugins.md`).
...
for `section-04-install-plugins` to understand what this section should contain.
...
`/home/user/sitemgr/specs/plugin-setup/sections/section-04-install-plugins.md`
