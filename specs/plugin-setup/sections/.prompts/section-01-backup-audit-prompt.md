...
Generate content for section `section-01-backup-audit` (filename: `section-01-backup-audit.md`).
...
for `section-01-backup-audit` to understand what this section should contain.
...
`/home/user/sitemgr/specs/plugin-setup/sections/section-01-backup-audit.md`
