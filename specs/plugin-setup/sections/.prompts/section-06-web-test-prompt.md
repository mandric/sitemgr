...
Generate content for section `section-06-web-test` (filename: `section-06-web-test.md`).
...
for `section-06-web-test` to understand what this section should contain.
...
`/home/user/sitemgr/specs/plugin-setup/sections/section-06-web-test.md`
