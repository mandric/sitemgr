...
Generate content for section `section-03-smoke-test` (filename: `section-03-smoke-test.md`).
...
for `section-03-smoke-test` to understand what this section should contain.
...
`/home/user/sitemgr/specs/12-fix-integration-ci-env-vars/sections/section-03-smoke-test.md`
