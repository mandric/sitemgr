...
Generate content for section `section-01-ci-workflow` (filename: `section-01-ci-workflow.md`).
...
for `section-01-ci-workflow` to understand what this section should contain.
...
`/home/user/sitemgr/specs/12-fix-integration-ci-env-vars/sections/section-01-ci-workflow.md`
