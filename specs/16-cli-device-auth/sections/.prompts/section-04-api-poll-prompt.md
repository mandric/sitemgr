...
Generate content for section `section-04-api-poll` (filename: `section-04-api-poll.md`).
...
for `section-04-api-poll` to understand what this section should contain.
...
`/home/user/sitemgr/specs/16-cli-device-auth/sections/section-04-api-poll.md`
