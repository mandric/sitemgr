...
Generate content for section `section-06-web-ui` (filename: `section-06-web-ui.md`).
...
for `section-06-web-ui` to understand what this section should contain.
...
`/home/user/sitemgr/specs/16-cli-device-auth/sections/section-06-web-ui.md`
