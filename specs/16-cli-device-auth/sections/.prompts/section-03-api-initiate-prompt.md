...
Generate content for section `section-03-api-initiate` (filename: `section-03-api-initiate.md`).
...
for `section-03-api-initiate` to understand what this section should contain.
...
`/home/user/sitemgr/specs/16-cli-device-auth/sections/section-03-api-initiate.md`
