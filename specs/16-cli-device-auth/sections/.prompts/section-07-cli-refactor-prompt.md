...
Generate content for section `section-07-cli-refactor` (filename: `section-07-cli-refactor.md`).
...
for `section-07-cli-refactor` to understand what this section should contain.
...
`/home/user/sitemgr/specs/16-cli-device-auth/sections/section-07-cli-refactor.md`
