...
Generate content for section `section-02-server-helpers` (filename: `section-02-server-helpers.md`).
...
for `section-02-server-helpers` to understand what this section should contain.
...
`/home/user/sitemgr/specs/16-cli-device-auth/sections/section-02-server-helpers.md`
