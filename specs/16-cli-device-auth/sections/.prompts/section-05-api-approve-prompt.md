...
Generate content for section `section-05-api-approve` (filename: `section-05-api-approve.md`).
...
for `section-05-api-approve` to understand what this section should contain.
...
`/home/user/sitemgr/specs/16-cli-device-auth/sections/section-05-api-approve.md`
