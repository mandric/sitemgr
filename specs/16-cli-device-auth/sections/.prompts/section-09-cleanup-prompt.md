...
Generate content for section `section-09-cleanup` (filename: `section-09-cleanup.md`).
...
for `section-09-cleanup` to understand what this section should contain.
...
`/home/user/sitemgr/specs/16-cli-device-auth/sections/section-09-cleanup.md`
