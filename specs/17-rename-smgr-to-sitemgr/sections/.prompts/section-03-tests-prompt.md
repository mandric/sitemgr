...
Generate content for section `section-03-tests` (filename: `section-03-tests.md`).
...
for `section-03-tests` to understand what this section should contain.
...
`/home/user/sitemgr/specs/17-rename-smgr-to-sitemgr/sections/section-03-tests.md`
