...
Generate content for section `section-05-docs` (filename: `section-05-docs.md`).
...
for `section-05-docs` to understand what this section should contain.
...
`/home/user/sitemgr/specs/17-rename-smgr-to-sitemgr/sections/section-05-docs.md`
