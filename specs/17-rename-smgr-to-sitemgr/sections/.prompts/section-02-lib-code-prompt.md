...
Generate content for section `section-02-lib-code` (filename: `section-02-lib-code.md`).
...
for `section-02-lib-code` to understand what this section should contain.
...
`/home/user/sitemgr/specs/17-rename-smgr-to-sitemgr/sections/section-02-lib-code.md`
