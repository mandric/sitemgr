...
Generate content for section `section-01-cli-binary` (filename: `section-01-cli-binary.md`).
...
for `section-01-cli-binary` to understand what this section should contain.
...
`/home/user/sitemgr/specs/17-rename-smgr-to-sitemgr/sections/section-01-cli-binary.md`
