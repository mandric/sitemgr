...
Generate content for section `section-02-test-integration-sh` (filename: `section-02-test-integration-sh.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/mandric/dev/github.com/mandric/sitemgr/specs/09-local-dev-setup/claude-plan.md` - Full implementation plan
2. `/Users/mandric/dev/github.com/mandric/sitemgr/specs/09-local-dev-setup/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/mandric/dev/github.com/mandric/sitemgr/specs/09-local-dev-setup/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-02-test-integration-sh` to understand what this section should contain.
...
`/Users/mandric/dev/github.com/mandric/sitemgr/specs/09-local-dev-setup/sections/section-02-test-integration-sh.md`
