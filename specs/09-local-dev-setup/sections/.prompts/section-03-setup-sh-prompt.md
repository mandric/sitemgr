...
Generate content for section `section-03-setup-sh` (filename: `section-03-setup-sh.md`).
...
for `section-03-setup-sh` to understand what this section should contain.
...
`/Users/mandric/dev/github.com/mandric/sitemgr/specs/09-local-dev-setup/sections/section-03-setup-sh.md`
