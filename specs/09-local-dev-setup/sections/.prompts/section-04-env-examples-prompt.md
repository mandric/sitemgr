...
Generate content for section `section-04-env-examples` (filename: `section-04-env-examples.md`).
...
for `section-04-env-examples` to understand what this section should contain.
...
`/Users/mandric/dev/github.com/mandric/sitemgr/specs/09-local-dev-setup/sections/section-04-env-examples.md`
