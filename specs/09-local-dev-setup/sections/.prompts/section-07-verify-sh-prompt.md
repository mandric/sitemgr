...
Generate content for section `section-07-verify-sh` (filename: `section-07-verify-sh.md`).
...
for `section-07-verify-sh` to understand what this section should contain.
...
`/Users/mandric/dev/github.com/mandric/sitemgr/specs/09-local-dev-setup/sections/section-07-verify-sh.md`
