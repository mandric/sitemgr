...
Generate content for section `section-01-local-dev-sh` (filename: `section-01-local-dev-sh.md`).
...
for `section-01-local-dev-sh` to understand what this section should contain.
...
`/Users/mandric/dev/github.com/mandric/sitemgr/specs/09-local-dev-setup/sections/section-01-local-dev-sh.md`
