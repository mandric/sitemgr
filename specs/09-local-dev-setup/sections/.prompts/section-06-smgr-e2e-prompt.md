...
Generate content for section `section-06-smgr-e2e` (filename: `section-06-smgr-e2e.md`).
...
for `section-06-smgr-e2e` to understand what this section should contain.
...
`/Users/mandric/dev/github.com/mandric/sitemgr/specs/09-local-dev-setup/sections/section-06-smgr-e2e.md`
