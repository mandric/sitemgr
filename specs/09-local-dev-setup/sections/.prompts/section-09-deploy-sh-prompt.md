...
Generate content for section `section-09-deploy-sh` (filename: `section-09-deploy-sh.md`).
...
for `section-09-deploy-sh` to understand what this section should contain.
...
`/Users/mandric/dev/github.com/mandric/sitemgr/specs/09-local-dev-setup/sections/section-09-deploy-sh.md`
