...
Generate content for section `section-05-delete-legacy` (filename: `section-05-delete-legacy.md`).
...
for `section-05-delete-legacy` to understand what this section should contain.
...
`/Users/mandric/dev/github.com/mandric/sitemgr/specs/09-local-dev-setup/sections/section-05-delete-legacy.md`
