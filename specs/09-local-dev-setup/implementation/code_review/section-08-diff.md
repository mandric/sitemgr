...
+2. `./scripts/local-dev.sh print_setup_env_vars > .env.local` — starts Supabase and writes `.env.local` with all required vars including a generated encryption key
