...
Generate content for section `section-04-cli-dedup` (filename: `section-04-cli-dedup.md`).
...
for `section-04-cli-dedup` to understand what this section should contain.
...
`/home/user/sitemgr/specs/19-dedup-detection/sections/section-04-cli-dedup.md`
