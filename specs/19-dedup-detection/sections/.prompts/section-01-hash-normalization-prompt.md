...
Generate content for section `section-01-hash-normalization` (filename: `section-01-hash-normalization.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/user/sitemgr/specs/19-dedup-detection/claude-plan.md` - Full implementation plan
2. `/home/user/sitemgr/specs/19-dedup-detection/claude-plan-tdd.md` - Test stubs for each section
3. `/home/user/sitemgr/specs/19-dedup-detection/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-01-hash-normalization` to understand what this section should contain.
...
`/home/user/sitemgr/specs/19-dedup-detection/sections/section-01-hash-normalization.md`
