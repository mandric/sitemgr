...
Generate content for section `section-04-verification-cleanup` (filename: `section-04-verification-cleanup.md`).
...
for `section-04-verification-cleanup` to understand what this section should contain.
...
`/home/user/sitemgr/specs/20-test-suite-reorg/sections/section-04-verification-cleanup.md`
