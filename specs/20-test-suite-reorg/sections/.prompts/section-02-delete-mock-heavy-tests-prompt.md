...
Generate content for section `section-02-delete-mock-heavy-tests` (filename: `section-02-delete-mock-heavy-tests.md`).
...
for `section-02-delete-mock-heavy-tests` to understand what this section should contain.
...
`/home/user/sitemgr/specs/20-test-suite-reorg/sections/section-02-delete-mock-heavy-tests.md`
