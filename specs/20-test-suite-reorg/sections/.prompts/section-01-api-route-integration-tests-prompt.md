...
Generate content for section `section-01-api-route-integration-tests` (filename: `section-01-api-route-integration-tests.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/user/sitemgr/specs/20-test-suite-reorg/claude-plan.md` - Full implementation plan
2. `/home/user/sitemgr/specs/20-test-suite-reorg/claude-plan-tdd.md` - Test stubs for each section
3. `/home/user/sitemgr/specs/20-test-suite-reorg/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-01-api-route-integration-tests` to understand what this section should contain.
...
`/home/user/sitemgr/specs/20-test-suite-reorg/sections/section-01-api-route-integration-tests.md`
