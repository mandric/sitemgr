...
Generate content for section `section-04-s3-hardening` (filename: `section-04-s3-hardening.md`).
...
for `section-04-s3-hardening` to understand what this section should contain.
...
`/home/user/sitemgr/02-media-pipeline/sections/section-04-s3-hardening.md`
