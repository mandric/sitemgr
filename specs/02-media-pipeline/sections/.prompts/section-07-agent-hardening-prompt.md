...
Generate content for section `section-07-agent-hardening` (filename: `section-07-agent-hardening.md`).
...
for `section-07-agent-hardening` to understand what this section should contain.
...
`/home/user/sitemgr/02-media-pipeline/sections/section-07-agent-hardening.md`
