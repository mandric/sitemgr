...
Generate content for section `section-01-logger` (filename: `section-01-logger.md`).
...
for `section-01-logger` to understand what this section should contain.
...
`/home/user/sitemgr/02-media-pipeline/sections/section-01-logger.md`
