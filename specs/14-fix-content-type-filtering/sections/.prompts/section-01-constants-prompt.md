...
Generate content for section `section-01-constants` (filename: `section-01-constants.md`).
...
for `section-01-constants` to understand what this section should contain.
...
`/home/user/sitemgr/specs/14-fix-content-type-filtering/sections/section-01-constants.md`
