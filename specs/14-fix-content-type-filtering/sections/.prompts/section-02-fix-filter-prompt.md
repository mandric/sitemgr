...
Generate content for section `section-02-fix-filter` (filename: `section-02-fix-filter.md`).
...
for `section-02-fix-filter` to understand what this section should contain.
...
`/home/user/sitemgr/specs/14-fix-content-type-filtering/sections/section-02-fix-filter.md`
