...
Generate content for section `section-04-verification` (filename: `section-04-verification.md`).
...
for `section-04-verification` to understand what this section should contain.
...
`/home/user/sitemgr/specs/14-fix-content-type-filtering/sections/section-04-verification.md`
