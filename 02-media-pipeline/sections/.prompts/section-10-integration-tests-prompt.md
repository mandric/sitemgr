...
Generate content for section `section-10-integration-tests` (filename: `section-10-integration-tests.md`).
...
for `section-10-integration-tests` to understand what this section should contain.
...
`/home/user/sitemgr/02-media-pipeline/sections/section-10-integration-tests.md`
