...
Generate content for section `section-02-retry-sdk` (filename: `section-02-retry-sdk.md`).
...
for `section-02-retry-sdk` to understand what this section should contain.
...
`/home/user/sitemgr/02-media-pipeline/sections/section-02-retry-sdk.md`
