...
Generate content for section `section-08-cli-hardening` (filename: `section-08-cli-hardening.md`).
...
for `section-08-cli-hardening` to understand what this section should contain.
...
`/home/user/sitemgr/02-media-pipeline/sections/section-08-cli-hardening.md`
