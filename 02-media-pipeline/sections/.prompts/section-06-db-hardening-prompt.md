...
Generate content for section `section-06-db-hardening` (filename: `section-06-db-hardening.md`).
...
for `section-06-db-hardening` to understand what this section should contain.
...
`/home/user/sitemgr/02-media-pipeline/sections/section-06-db-hardening.md`
