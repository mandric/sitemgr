...
Generate content for section `section-05-enrichment-hardening` (filename: `section-05-enrichment-hardening.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/user/sitemgr/02-media-pipeline/claude-plan.md` - Full implementation plan
2. `/home/user/sitemgr/02-media-pipeline/claude-plan-tdd.md` - Test stubs for each section
3. `/home/user/sitemgr/02-media-pipeline/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-05-enrichment-hardening` to understand what this section should contain.
...
`/home/user/sitemgr/02-media-pipeline/sections/section-05-enrichment-hardening.md`
