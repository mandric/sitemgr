...
Generate content for section `section-01-script-fixes` (filename: `section-01-script-fixes.md`).
...
for `section-01-script-fixes` to understand what this section should contain.
...
`/home/user/sitemgr/planning/sections/section-01-script-fixes.md`
