...
Generate content for section `section-02-shellcheck-ci` (filename: `section-02-shellcheck-ci.md`).
...
for `section-02-shellcheck-ci` to understand what this section should contain.
...
`/home/user/sitemgr/planning/sections/section-02-shellcheck-ci.md`
