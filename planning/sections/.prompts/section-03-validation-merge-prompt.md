...
Generate content for section `section-03-validation-merge` (filename: `section-03-validation-merge.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/user/sitemgr/planning/claude-plan.md` - Full implementation plan
2. `/home/user/sitemgr/planning/claude-plan-tdd.md` - Test stubs for each section
3. `/home/user/sitemgr/planning/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-03-validation-merge` to understand what this section should contain.
...
`/home/user/sitemgr/planning/sections/section-03-validation-merge.md`
