diff --git a/web/__tests__/rls-policies.test.ts b/web/__tests__/rls-policies.test.ts
new file mode 100644
index 0000000..5a855e7
--- /dev/null
+++ b/web/__tests__/rls-policies.test.ts
@@ -0,0 +1,340 @@
+/**
...
diff --git a/web/vitest.integration.config.ts b/web/vitest.integration.config.ts
new file mode 100644
index 0000000..00545bb
--- /dev/null
+++ b/web/vitest.integration.config.ts
@@ -0,0 +1,20 @@
