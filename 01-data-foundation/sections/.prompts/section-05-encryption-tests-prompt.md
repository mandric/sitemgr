...
Generate content for section `section-05-encryption-tests` (filename: `section-05-encryption-tests.md`).
...
for `section-05-encryption-tests` to understand what this section should contain.
...
`/home/user/sitemgr/01-data-foundation/sections/section-05-encryption-tests.md`
