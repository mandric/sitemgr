...
Generate content for section `section-08-phone-migration` (filename: `section-08-phone-migration.md`).
...
for `section-08-phone-migration` to understand what this section should contain.
...
`/home/user/sitemgr/01-data-foundation/sections/section-08-phone-migration.md`
