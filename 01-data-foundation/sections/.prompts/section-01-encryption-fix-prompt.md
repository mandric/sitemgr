...
Generate content for section `section-01-encryption-fix` (filename: `section-01-encryption-fix.md`).
...
for `section-01-encryption-fix` to understand what this section should contain.
...
`/home/user/sitemgr/01-data-foundation/sections/section-01-encryption-fix.md`
