...
Generate content for section `section-06-rls-tests` (filename: `section-06-rls-tests.md`).
...
for `section-06-rls-tests` to understand what this section should contain.
...
`/home/user/sitemgr/01-data-foundation/sections/section-06-rls-tests.md`
