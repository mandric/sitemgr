...
Generate content for section `section-10-documentation` (filename: `section-10-documentation.md`).
...
for `section-10-documentation` to understand what this section should contain.
...
`/home/user/sitemgr/01-data-foundation/sections/section-10-documentation.md`
