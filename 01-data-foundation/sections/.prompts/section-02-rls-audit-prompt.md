...
Generate content for section `section-02-rls-audit` (filename: `section-02-rls-audit.md`).
...
for `section-02-rls-audit` to understand what this section should contain.
...
`/home/user/sitemgr/01-data-foundation/sections/section-02-rls-audit.md`
